...
public class SwagLabsTest {
    ...
    public void ItencardTitleAndDescription() throws InterruptedException {
        ...
        expectedText = driver.findElement(By.xpath("//*[@id=\"item_0_title_link\"]/div")).getText();
    ...
    public void ItemCardPriceCurrency() throws InterruptedException, IOException {
        ...
        if (expectedText.equals(actualText)) {
            ...
            System.out.println("Item Card Test: Successfull");
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\ItemCardtestComplete.png");
            ...
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\ItemCardTestFail.png");
            System.out.println("SnapShot Captured");
    ...
    public void CheckoutPage() throws InterruptedException, IOException {
        ...
        //===============================================
        //Fill input fields
        driver.findElement(By.xpath("//*[@id=\"first-name\"]")).sendKeys("Leeshani");
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"last-name\"]")).sendKeys("Dilthara");
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"postal-code\"]")).sendKeys("12400");
        Thread.sleep(1000);
        ...
        if (expectedText.equals(actualText)) {
            ...
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\LoadCheckoutOverviewComplete.png");

        }
        else {
            System.out.println("\nCheckout Customer Details Submit : FAIL");
            System.out.println("Error loading Checkout: Overview Page");
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\LoadCheckoutOverviewError.png");
    ...
    public void PaymentInformation() {
        ...
        //Check Payment Information Title
        ...
        if (expectedText.equals(actualText)) {
            System.out.println("Payment Information Test: PASS");
        }
        else {
    ...
    public void PriceTotal() throws IOException, InterruptedException {
        ...
        if (expectedTotal.equals(actualTotal)) {
            ...
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\PaymentInfoPageComplete.png");
            System.out.println("SnapShot Captured");
        }
        else {
            System.out.println("\nTotal Price Calculation Test: FAIL");
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\PaymentInfoPageError.png");
            System.out.println("SnapShot Captured");
        }
    ...
    public void ThankyouPage() throws IOException, InterruptedException {
        ...
        if (expectedText.equals(actualText)){
            ...
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\OrderComplete.png");
            System.out.println("SnapShot Captured");
        }
        else {
            System.out.println("Order Placing Fail");
            System.out.println("THank you Page Load : FAIL");
            takeSnapShot(driver,"C:\\Users\\USER\\OneDrive\\Desktop\\SwagLabs Test\\Swag-Labs-Test-Automation\\Snapshots\\OrderFail.png");
            System.out.println("SnapShot Captured");
        }
